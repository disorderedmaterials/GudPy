        ...
        for key in gudAttrsDict.keys():
            ...
            if key == "groupsTable":
                ...
                for rowA, rowB in zip(self.expectedGudFileA[key].split("\n"), gf.groupsTable.split("\n")):
                 ...
                 self.assertAlmostEqual(float(self.expectedGudFileA[key].replace("%", '')), float(gudAttrsDict[key].replace("%", '')), 1)
            elif key == "err":
                self.assertAlmostEqual(extract_floats_from_string(self.expectedGudFileA[key][0]), extract_floats_from_string(gudAttrsDict[key][0]), 1)
            else:
                try:
                    self.assertEqual(self.expectedGudFileA[key], gudAttrsDict[key])
                except AssertionError as e:
                    try:
                        self.assertAlmostEqual(float(self.expectedGudFileA[key].strip()), float(gudAttrsDict[key].strip()), 1)
                    except:
                        raise e
        ...
        for key in gudAttrsDict.keys():
            ...
            if key == "groupsTable":
                ...
                for rowA, rowB in zip(self.expectedGudFileB[key].split("\n"), gf.groupsTable.split("\n")):
                 ...
                 self.assertAlmostEqual(float(self.expectedGudFileB[key].replace("%", '')), float(gudAttrsDict[key].replace("%", '')), 1)
            elif key == "result":
                self.assertAlmostEqual(extract_floats_from_string(self.expectedGudFileB[key][0]), extract_floats_from_string(gudAttrsDict[key][0]), 1)
            else:
                try:
                    self.assertEqual(self.expectedGudFileB[key], gudAttrsDict[key])
                except AssertionError as e:
                    try:
                        self.assertAlmostEqual(float(self.expectedGudFileB[key].strip()), float(gudAttrsDict[key].strip()), 1)
                    except:
                        raise e
        ...
        for key in gudAttrsDict.keys():
            ...
            if key == "groupsTable":
                ...
                for rowA, rowB in zip(self.expectedGudFileC[key].split("\n"), gf.groupsTable.split("\n")):
                 ...
                 self.assertAlmostEqual(float(self.expectedGudFileC[key].replace("%", '')), float(gudAttrsDict[key].replace("%", '')), 1)
            elif key == "result":
                self.assertAlmostEqual(extract_floats_from_string(self.expectedGudFileC[key][0]), extract_floats_from_string(gudAttrsDict[key][0]), 1)
            else:
                try:
                    self.assertEqual(self.expectedGudFileC[key], gudAttrsDict[key])
                except AssertionError as e:
                    try:
        ...
        for key in gudAttrsDict.keys():
            ...
            if key == "groupsTable":
                ...
                for rowA, rowB in zip(self.expectedGudFileD[key].split("\n"), gf.groupsTable.split("\n")):
                 ...
                 self.assertAlmostEqual(float(self.expectedGudFileD[key].replace("%", '')), float(gudAttrsDict[key].replace("%", '')), 1)
            elif key == "err":
                self.assertAlmostEqual(extract_floats_from_string(self.expectedGudFileA[key][0]), extract_floats_from_string(gudAttrsDict[key][0]), 1)
            else:
                try:
                    self.assertEqual(self.expectedGudFileD[key], gudAttrsDict[key])
                except AssertionError as e:
                    try:
